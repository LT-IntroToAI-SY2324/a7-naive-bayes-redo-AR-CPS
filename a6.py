...
if __name__ == "__main__":
    ...
    print(b.classify('This was delicious'))
    print(b.classify('fantastic job'))  
    print(b.classify("The solar eclipse is going to be boring, why should we waste our time?"))  
    print(b.classify("I hope you fail completely"))
    print(b.classify('I hate you'))
    print(b.classify('you are stupid'))
    print("\nThe following are real reviews")
    print("\n________________________________")
    print("\n")
    print(b.classify('one of keanus best movies since speed, john wick, a hitman in retirement goes after (in a rage) toward some russian gangsters who broke into his home, beat him senseless, stole his mustang, and killed his beagle puppy dog which was a gift to him from his late wife who recently passed. non-stop action, great pacing, great acting some humorous dark moments all add up to a good time killing B movie. a 8 out of 10.'))
    print(b.classify('The John Wick movie was an absolute masterpiece. It captured the essence of action and thriller genres flawlessly, delivering an exhilarating and unforgettable experience. The films brilliant cinematography, intense fight choreography, and captivating storytelling all contributed to its immense success. From start to finish, John Wick kept audiences on the edge of their seats, leaving them in awe of its exceptional execution. It truly was a remarkable film that will be remembered for years to come.'))
    print("\n________________________________")
    print("\n")
    print(b.classify('I really like Keanu Reeves. And I enjoyed the the first JW movie. But they have become cartoonish with JW behaving like some invulnerable super hero. All action, little plot. I would love to see them dial back the ridiculously high body count and concentrate on a good plot, an engaging story. He can still be a badass, just one that has some depth. Not just a robotic killing machine. We already had a Terminator.'))
    print(b.classify('Ive been watching Keanu Reeves movies for decades now, convincing myself that he must be a decent actor to merit such fame...it still isnt working. For all the hype, in my heart, I know that hes very ordinary, at best. John Wick is yet another action hero bent on revenge, of course, chasing down dozens of Russian gangsters who stole his car and killed his dog. Yep, seriously. For some reason, people love this garbage. Fair enough I guess, I mean it is nicely shot.'))